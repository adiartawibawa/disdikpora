...
class GuruTendikImporter extends Importer
{
    ...
    public function resolveRecord(): ?GuruTendik
    {
        ...
        GuruTendikTugas::firstOrCreate(
            [
                'guru_tendik_id' => $guruTendik->id,
                'organisation_id' => $sekolah,
            ],
            [
        ...
        GuruTendikKepegawaian::firstOrCreate(
            [
                'guru_tendik_id' => $guruTendik->id
            ],
            [
        ...
        if ($this->data['Status_Tugas'] === 'Induk') {
            $user->organisation_id = $sekolah;
            $user->save();

            $guruTendik->organisation_id = $sekolah;
            $guruTendik->save();
        }
    ...
    private function getTempatTugas($npsn)
    {
        ...
        return $sekolah->organisation_id;
    }
}
