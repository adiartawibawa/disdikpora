<div class="card w-full bg-base-100 shadow-xl relative overflow-hidden h-52">
    ...
    <div class="card-body relative">
        <h2 class="text-4xl font-bold">{{ $sekolah }}</h2>
        <p class="mt-2 font-sans text-base font-medium text-gray-500">
            Satuan Pendidikan
        </p>
        <div class="grid grid-cols-2 col-span-2 gap-2 w-[60%] mt-4 ">
            <div class="font-sans text-base font-medium text-gray-500 hover:underline hover:text-primary">
                <a href="#">
                    Negeri
                    <span> : 10</span>
                </a>
            ...
            {{-- @foreach ($jenjang as $item)
                @foreach ($item as $key => $value)
                    <div class="font-sans text-sm font-medium text-gray-500 hover:underline hover:text-primary">
                        <a href="#">
                            {{ Str::upper($key) }}
                            <span> : {{ $value }}</span>
                        </a>
