<div>
    <div class="mx-auto max-w-[43rem]">
        <div class="text-center">
            <p class="text-lg font-medium leading-8 text-indigo-600/95">Selamat Datang di Website</p>
            <h1 class="mt-3 text-[3.5rem] font-bold leading-[4rem] tracking-tight text-black">
                Dinas Pendidikan, Kepemudaan dan Olah Raga</h1>
            <p class="mt-3 text-lg leading-relaxed text-slate-400">Kabupaten Badung</p>
        </div>
