...
<head>
    ...
    <link rel="shortcut icon" href="https://upload.wikimedia.org/wikipedia/commons/d/d2/Lambang_Kabupaten_Badung.png"
        type="image/x-icon">
        ...
        <nav class="container relative flex items-center justify-between px-6 py-4 md:py-0 mx-auto text-red-800">
            <a href="/" class="inline-flex items-center space-x-2">
                <img class="w-8 h-8 md:w-12 md:h-12"
                    ...
                    alt="Logo Kabupaten Badung" srcset="">
                <p class="uppercase flex-wrap w-72 text-xs text-gray-800 font-bold">
    ...
    <footer class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-12 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                <div>
                    <p class="font-semibold text-gray-800 dark:text-white">Dinas Pendidikan, Kepemudaan dan Olah Raga
                        Kabupaten Badung</p>

                    <p class="max-w-sm mt-2 text-gray-500 dark:text-gray-400">Jl. Raya Sempidi - Mengwi - Badung, Bali
                    </p>
                ...
                <div>
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-2">
                        <a href="#"
                            ...
                            0361 900926</a>
                        <a href="#"
                            class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-red-400 hover:underline hover:text-red-500">badungdisdikpora@gmail.com</a>
                    </div>
                </div>
            </div>
